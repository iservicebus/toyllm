...
class Encoder:
    ...
    def __init__(self, 
                encoder_remote_file: str = 'https://openaipublic.blob.core.windows.net/gpt-2/models/124M/encoder.json',
                vocab_remote_file: str =  'https://openaipublic.blob.core.windows.net/gpt-2/models/124M/vocab.bpe',
        ...
        assert len(self.encoder) == 50257 # 256 individual byte tokens, 50,000 merged tokens, and 1 special <|endoftext|> token
        ...
        self.bpe_merges = [tuple(merge_str.split()) for merge_str in bpe_data.split('\n')[1:-1]]
        assert len(self.bpe_merges) == 50000 # 50,000 merged tokens
    ...
    def encode(self, text):
        ...
        tokens = regex.findall(self.pat, text)
...
class BPETokenizer:
    ...
    def __call__(self, text, return_tensors='pt'):
        ...
        unique_values = torch.unique(out, return_counts=False)
